...
const manifestPath = process.env.TEST_MANIFEST_PATH || path.join(__dirname, '..', 'app-build-manifest.json');
...
function downloadFile(url, filePath) {
  return new Promise((resolve, reject) => {
    try {
      ...
      const testFile = 'C:/Users/USER/OneDrive/Desktop/headp/headlamp-55-Kallal/test-bundling-direct/test-plugin-1.0.0.tgz';
